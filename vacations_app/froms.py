...
class VacationForm(forms.ModelForm):
    ...
    description = forms.CharField(required=True, label='Description', validators=[MinLengthValidator(10, message="Description must be at least 10 characters")])
    ...
    price = forms.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(1, message="Price must be greater than 0"), MaxValueValidator(10000, message="Price must be less than 10000")], required=True, label='Price', widget=forms.NumberInput(attrs={'type': 'number'}))
